...
#
# Свой Xray убран целиком: вход на 443, запасные 2053 и 2083, подписка наружу
# на 2096. Правила на них остались бы открытыми дверями, за которыми никто не
...
if command -v ufw >/dev/null 2>&1; then
    for XPORT in 443 2053 2083 2096; do
