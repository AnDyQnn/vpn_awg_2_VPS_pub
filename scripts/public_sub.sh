...
# наружу не опубликована: на публичном адресе заняты 443 (вход Xray) и
# 51820/51821 (UDP). Проверить — ss -lntp, строка с :80.
#
...
# Порт наружу. 2096 — общеизвестный запасной HTTPS из того же ряда, что 2053
# и 2083: среди чужого трафика не выделяется.
#
