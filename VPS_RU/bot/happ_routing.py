...
async def profile(uuid_val=None):
    ...
    # Сеть узла — через туннель, и сказано это прямо. Само по себе оно уже
    # работает: из «домашнего» правила наша /24 вырезана, а несовпавшее
    # приложение отправляет в туннель. Но правило, написанное явно, видно
    # глазами в присланном конфиге и не зависит от того, в каком порядке
    # приложение разложит списки.
