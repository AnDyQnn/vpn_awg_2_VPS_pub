...
# Сеть для стенда берём из диапазона, выделенного под примеры. Раньше здесь
# стояла настоящая сеть нашего узла — в открытом репозитории это сужало поиск
# машины до блока одного провайдера. Правилам всё равно, какая это сеть.
