...
| **Клиентам** | Личный кабинет, скачивание конфигов и QR, **подписка Clash Mi** (тот же ключ ссылкой, обновляется сам), проверка соединения, статистика трафика, тикеты в поддержку |
...
> **Подписка Clash Mi** — тот же ключ AmneziaWG ссылкой для клиентов на mihomo:
> [docs/clashsub.md](docs/clashsub.md).
